...
<html>
<head>
   <title>ESP-32 COLOR DETECTION</title>
   <meta charset="utf-8">
...
<div class ="video-container">
  ...
  <center><img id="ShowImage" src="" style=""></center>
...
colorDetect.onclick = function (event) {
  ...
  ShowImage.src="http://" +location.host + ":81" + "/stream";
}
...
async function DetectImage() {
  ...
  try{
   if(b_invert==false){
    ...
    await fetch(document.location.origin+'/location?x='+Math.round(x_cm)+'&'+"y="+Math.round(y_cm));
